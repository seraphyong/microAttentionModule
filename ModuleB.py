...
class InceptionI3d(snt.AbstractModule):
    ...
    def _build(self, inputs, is_training, dropout_keep_prob=1.0):
        ...
        with tf.variable_scope(end_point):
            with tf.variable_scope('AttBranch'):
                branch_att_ = Unit3D(output_channels=256, kernel_shape=[1, 1, 1],
                                  name='Conv3d_0a_1x1')(net, is_training=is_training)
                branch_att = tf.nn.max_pool3d(branch_att_, ksize=[1, 3, 3, 3, 1],
        ...
        with tf.variable_scope(end_point):
            with tf.variable_scope('AttBranch'):
                branch_att_ = Unit3D(output_channels=480, kernel_shape=[1, 1, 1],
                                  name='Conv3d_0a_1x1')(net, is_training=is_training)
                branch_att = tf.nn.max_pool3d(branch_att_, ksize=[1, 3, 3, 3, 1],
                                              strides=[1, 1, 1, 1, 1], padding=snt.SAME,
                                              name='MaxPool3d_1a_3x3')
        ...
        with tf.variable_scope(end_point):
            with tf.variable_scope('AttBranch'):
                branch_att_ = Unit3D(output_channels=512, kernel_shape=[1, 1, 1],
                                  name='Conv3d_0a_1x1')(net, is_training=is_training)
                branch_att = tf.nn.max_pool3d(branch_att_, ksize=[1, 3, 3, 3, 1],
                                              strides=[1, 1, 1, 1, 1], padding=snt.SAME,
                                              name='MaxPool3d_1a_3x3')
        ...
        with tf.variable_scope(end_point):
            with tf.variable_scope('AttBranch'):
                branch_att_ = Unit3D(output_channels=528, kernel_shape=[1, 1, 1],
                                  name='Conv3d_0a_1x1')(net, is_training=is_training)
                branch_att = tf.nn.max_pool3d(branch_att_, ksize=[1, 3, 3, 3, 1],
                                              strides=[1, 1, 1, 1, 1], padding=snt.SAME,
                                              name='MaxPool3d_1a_3x3')
        ...
        with tf.variable_scope(end_point):
            with tf.variable_scope('AttBranch'):
                branch_att_ = Unit3D(output_channels=832, kernel_shape=[1, 1, 1],
                                  name='Conv3d_0a_1x1')(net, is_training=is_training)
                branch_att = tf.nn.max_pool3d(branch_att_, ksize=[1, 3, 3, 3, 1],
                                              strides=[1, 1, 1, 1, 1], padding=snt.SAME,
                                              name='MaxPool3d_1a_3x3')
        ...
        with tf.variable_scope(end_point):
            with tf.variable_scope('AttBranch'):
                branch_att_ = Unit3D(output_channels=1024, kernel_shape=[1, 1, 1],
                                  name='Conv3d_0a_1x1')(net, is_training=is_training)
                branch_att = tf.nn.max_pool3d(branch_att_, ksize=[1, 3, 3, 3, 1],
                                              strides=[1, 1, 1, 1, 1], padding=snt.SAME,
                                              name='MaxPool3d_1a_3x3')
